<script setup>
    ...
    // const SelectsDepartments = computed({
    //     get() {
    //         // Join the departments array into a string to be compatible with multi-select input
    //         return instituteStore.instituteInputs.departments.join(', ');
    //     },

    //     set(value){
    //         instituteStore.instituteInputs.departments = value.filter((v) => v !== "").join(', ');
    //     }
    // })
...
<template>
    <div id="create-institute" class="hs-overlay hidden size-full fixed top-0 start-0 z-[80] overflow-x-hidden overflow-y-auto pointer-events-none" role="dialog" tabindex="-1" aria-labelledby="create-institute-label">
        <div class="hs-overlay-open:mt-7 hs-overlay-open:opacity-100 hs-overlay-open:duration-500 mt-0 opacity-0 ease-out transition-all lg:max-w-4xl lg:w-full m-3 lg:mx-auto">
            <div class="flex flex-col bg-white border shadow-sm rounded-xl pointer-events-auto dark:bg-neutral-800 dark:border-neutral-700 dark:shadow-neutral-700/70">
                <div class="flex justify-between items-center py-3 px-4 border-b dark:border-neutral-700">
                    <h3 id="create-institute-label" class="font-semibold text-[#3eaf7c]">
                    Create Institute
                    </h3>
                    <button @click="instituteStore.reset" type="button" class="size-8 inline-flex justify-center items-center gap-x-2 rounded-full border border-transparent bg-gray-100 text-gray-800 hover:bg-gray-200 focus:outline-none focus:bg-gray-200 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-700 dark:hover:bg-neutral-600 dark:text-neutral-400 dark:focus:bg-neutral-600" aria-label="Close" data-hs-overlay="#create-institute">
                ...
                <div class="p-4 overflow-y-auto w-full">
                    <form @submit.prevent="instituteStore.createInstitute" class="space-y-2">
